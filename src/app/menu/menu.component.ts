...
export class MenuComponent implements OnInit {
  ...
  renderMenuItems() {
    ...
    // Append the last grid to the menuContainer
    if (grid) {
      menuContainer.appendChild(grid);
    }
  }
...
//       menuImage.src = '';
//
//       this.http.get(`${SERVER_ADDRESS}/image/${item.id}`, {
//         headers: {
//           'Authorization': `Basic ${this.token}`
//         },
//         responseType: 'blob'
...
//         reader.onloadend = () => {
//           const safeUrl: SafeUrl = this.sanitizer.bypassSecurityTrustUrl(reader.result as string);
//           this.renderer.setAttribute(menuImage, 'src', safeUrl.toString());
